...
interface RelationalDatabaseServerConfigFormWithoutCloudServiceNameProps {
  config: Record<string, unknown>;
  onChange: (config: Record<string, unknown>) => void;
}

const RelationalDatabaseServerConfigFormWithoutCloudServiceName = ({ config, onChange }: RelationalDatabaseServerConfigFormWithoutCloudServiceNameProps) => (
...
export default RelationalDatabaseServerConfigFormWithoutCloudServiceName;
